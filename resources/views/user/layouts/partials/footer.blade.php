        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7 mx-auto" style="text-align: center;">
                    ...
                    <a class="btn btn-kontak" href="https://api.whatsapp.com/send?phone=085299671969">
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-lg-4 col-md-4 bawah-dua">
                    <table>
                        <tr>
                            <td><a href=""><h5 style="margin-right: 10px">Terms of Service</h5></a></td>
                            <td><a href=""><h5 style="margin-right: 10px">Privacy Policy</h5></a></td>
                        </tr>
                    </table>
                </div>
            </div>
