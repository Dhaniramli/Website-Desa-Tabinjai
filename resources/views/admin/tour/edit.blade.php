...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800 text-center">Edit Produk Wisata</h1>
    <div class="row">
        <div class="col-lg-8 mx-auto my-auto">
            <div class="card shadow mb-4">
                <form method="POST" action="/admin/produk-wisata/{{ $item->id }}" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('put')
                        ...
                        <div class="mb-3">
                            <label for="address" class="form-label">Alamat Wisata</label>
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                                name="address" required value="{{ old('address', $item->address) }}">
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
